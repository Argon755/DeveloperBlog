            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="edicaMainNav">
                    <ul class="navbar-nav mx-auto mt-2 mt-lg-0">
                        ...
                        <li class="nav-item">
                            @auth()
                            <a class="nav-link" href="{{ route('personal.main.index')  }}">Выйти</a>
                            @endauth
                        </li>
                    </ul>
                </div>
    ...
    <footer class="edica-footer" data-aos="fade-up">
        <div class="container">
            ...
            <div class="footer-bottom-content">
                ...
                <p class="mb-0">© DevBLOG <a href="https://www.bootstrapdash.com" target="_blank" rel="noopener noreferrer" class="text-reset"></a> . All rights reserved.</p>
            </div>
        </div>
    </footer>
